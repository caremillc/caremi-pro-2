...
Careminate\Http\Request → Represents the incoming HTTP request (data, query params, method, headers, files).
...
Request captures incoming data.

Controller action inspects the request.

A Response is returned with appropriate content.

The framework sends it to the browser/client.
