...
| URL                | HTTP Method | Handler                 | Description           |
| ------------------ | ----------- | ----------------------- | --------------------- |
| `/`                | GET         | `HomeController@index`  | Home page             |
| `/hello/John`      | GET         | Closure                 | Dynamic greeting      |
| `/posts`           | GET         | `PostController@index`  | List posts            |
| `/posts/create`    | GET         | `PostController@create` | Show create post form |
| `/posts/store`     | POST        | `PostController@store`  | Save new post         |
| `/posts/2/show`    | GET         | `PostController@show`   | Show post with ID 2   |
| `/posts/2/edit`    | GET         | `PostController@edit`   | Edit post ID 2        |
| `/posts/2/update`  | PUT         | `PostController@update` | Update post ID 2      |
| `/posts/2/destroy` | DELETE      | `PostController@delete` | Delete post ID 2      |

---

This documentation serves as the canonical reference for all route registration and usage in Careminate.
?>
